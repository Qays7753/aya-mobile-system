...
GRANT SELECT (id, name, phone, address, is_active, created_at, updated_at) ON suppliers TO authenticated;
...
BEGIN 
  ...
  LOOP 
    ...
    IF t_name IN ('daily_snapshots', 'expenses', 'ledger_entries', 'reconciliation_entries') THEN
