-- Seed auth users (trigger should populate public.profiles)
...
VALUES ('aaaaaaaa-aaaa-aaaa-aaaa-aaaaaaaaaaaa','Cash Main','cash','core',1000,1000,1)
ON CONFLICT (id) DO NOTHING;
...
VALUES
('dddddddd-dddd-dddd-dddd-dddddddddddd','Phone A','device','SKU-PHONE-A',100,70,70,1,1,true,false,true,'11111111-1111-1111-1111-111111111111'),
